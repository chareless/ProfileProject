...
namespace ProfileProject.Models
{
    ...
    public class WorkExperience
    {
        ...
        public WorkExperience(string companyName, string title, string info, bool ısDeleted, DateTime start, DateTime end, DateTime create, DateTime update,int userId, User user)
        {
            Title = title;
